...
local data = { 
	...
	{2,"CanvasGroup", {Name = "Container", Parent = 1, BackgroundColor3 = Color3.fromRGB(20, 20, 20), AnchorPoint = Vector2.new(0.5, 0.5), Position = UDim2.fromScale(0.5, 0.5), Size = UDim2.fromScale(0.5, 0.5)}},
